...
async function handleClientAccess(token: string, password: string | null, request: NextRequest) {
...
export async function GET(request: NextRequest) {
  try {
    ...
    return handleClientAccess(token, null, request);
  } catch (error) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleClientAccess(token, password || null, request);
  } catch (error) {
